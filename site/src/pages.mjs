...
const security = {
  ...
  <section class="section shell disclosure" data-private-disclosure><div><p class="eyebrow">Report a vulnerability</p><h2>Use GitHub private vulnerability reporting.</h2><p>Do not open a public issue for suspected security defects or include credentials, private keys, account material, host data, or customer information in a report.</p></div><a class="button button-primary" data-private-report href="https://github.com/acmemux/AcmeMux/security/advisories/new">Open a private report ${arrow}</a></section>
...
const contribute = {
  ...
  <section class="section shell contribution-grid"><article><span>Discuss</span><h2>Shape the problem</h2><p>Use Discussions for experience reports, product questions, and proposed lifecycle needs before assuming an implementation.</p><a href="https://github.com/acmemux/AcmeMux/discussions">Start a discussion ${arrow}</a></article><article><span>Report</span><h2>Make defects reproducible</h2><p>Use public issues for non-sensitive bugs and include the smallest safe environment and behavior evidence.</p><a href="https://github.com/acmemux/AcmeMux/issues">Review issues ${arrow}</a></article><article><span>Improve</span><h2>Test, document, research</h2><p>Provider qualification, recovery cases, operator documentation, accessibility, and careful review all move the project forward.</p><a href="https://github.com/acmemux/AcmeMux/pulls">Review pull requests ${arrow}</a></article><article data-private-disclosure><span>Protect</span><h2>Disclose privately</h2><p>Suspected vulnerabilities and sensitive evidence belong in GitHub private vulnerability reporting, never a public issue.</p><a data-private-report href="https://github.com/acmemux/AcmeMux/security/advisories/new">Open a private report ${arrow}</a></article></section>
  <section class="section surface-section"><div class="shell contribution-note"><div><p class="eyebrow">Pull requests</p><h2>Small, attributable, reviewable changes.</h2></div><div><p>Contributions require Developer Certificate of Origin sign-off. A proposal or pull request does not create a response time, merge promise, support agreement, or commitment to ship a feature.</p><p>Start with the public issue or discussion context so reviewers can evaluate the operator outcome and security boundary, not only the code shape.</p><p>For a general project inquiry that does not fit an issue or discussion, email <a class="text-link" href="mailto:contact@certleap.net?subject=AcmeMux%20inquiry">contact@certleap.net</a>. This address is not a private vulnerability-reporting route or a support SLA.</p></div></div></section>`,
};
...
const sponsor = {
  ...
  <section class="section shell sponsor-wait"><p class="eyebrow">Funding route</p><h2>Start with the sponsorship address.</h2><p>Email <a href="mailto:sponsorship@certleap.net?subject=AcmeMux%20sponsorship">sponsorship@certleap.net</a> for a funding inquiry. A conversation or payment does not create an SLA, private support channel, roadmap priority, or delivery guarantee.</p><a class="text-link" href="mailto:sponsorship@certleap.net?subject=AcmeMux%20sponsorship">Discuss sponsorship ${arrow}</a></section>`,
};
